        ...
        <View className="px-4 pb-6">
          <View className="mb-4 flex-row items-center gap-3 rounded-2xl border border-border bg-primary/10 p-4">
            ...
            <Text className="flex-1 text-[13px] leading-snug text-foreground">
              Curtos, diretos e cheios de afeto. Escute quando precisar de um empurrao.
            </Text>
          </View>
          ...
          {items.length === 0 ? (
            <View className="items-center rounded-2xl border border-border bg-card p-8">
              <Text className="text-center text-sm text-muted-foreground">
                Nenhum audio publicado ainda. Volte em breve.
              </Text>
            </View>
          ) : (
                    ...
                    <View className="flex-row items-start gap-3">
                      ...
                      <View className="flex-1">
                        <Text className="text-[11px] font-medium uppercase tracking-wide text-muted-foreground">
                          Episodio {String(i + 1).padStart(2, "0")}
                        </Text>
                    ...
                    <View className="mt-3">
                      <TouchableOpacity
                        onPress={(e) => {
                          ...
                          const w = (e as any).nativeEvent.target;
                          // Simple seek approximation
                        }}
